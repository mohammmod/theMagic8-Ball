...
public class SentencesProcessor {
    public String giveOneSentence() {
        List<String> sentencesInitilaized = new ArrayList<>(8);
        List<String> sentences = addSentences(sentencesInitilaized);
        return getRandomSentence(sentences);
    }

    private List<String> addSentences(List<String> sentences) {
